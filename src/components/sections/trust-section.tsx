...
export default function TrustSection() {
  return (
    <Container parentClassName="bg-[url('/gradient-bottom.svg')] bg-contain bg-no-repeat bg-bottom" className="flex flex-col gap-16 md:pt-30 md:pb-52.5">
      <div className="relative w-full flex flex-col gap-59">
        <span className="text-[2.5rem] w-fit tracking-[-0.02em] text-transparent bg-linear-to-r from-30% from-foreground to-foreground/60 bg-clip-text">
          aman.ah
        </span>
        <div className="relative z-1 flex flex-col gap-8">
          <div className="relative rounded-xl overflow-hidden size-22.5">
        ...
        <Image className="absolute top-0 right-0" src="/template.svg" alt="template" width={599} height={558} />
      </div>
      <div className="relative z-1 flex flex-col gap-30">
        <div className="flex justify-between">
          <span className="text-2xl tracking-[-0.02em] text-transparent bg-linear-to-r from-30% from-foreground to-foreground/60 bg-clip-text">
        ...
        <div className="flex flex-col gap-9 items-center">
          <span className="text-[clamp(10rem,17.2vw,17rem)] tracking-[-0.04em] text-transparent bg-linear-to-r from-30% from-foreground to-foreground/60 bg-clip-text">
            2,873.929
          </span>
          <span className="text-2xl tracking-[-0.02em] text-transparent bg-linear-to-r from-30% from-foreground to-foreground/60 bg-clip-text">
